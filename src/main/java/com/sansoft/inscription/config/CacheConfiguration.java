package com.sansoft.inscription.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("ApplicationScolarite");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("ApplicationScolarite");
        ...
        config.getMapConfigs().put("com.sansoft.inscription.domain.*", initializeDomainMapConfig(jHipsterProperties));
